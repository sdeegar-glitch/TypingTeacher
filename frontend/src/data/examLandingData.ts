...
export const EXAM_LANDINGS: Record<string, ExamLanding> = {
  ...
  'cpct': {
    ...
    seoTitle: 'CPCT Typing Test — Free Hindi & English Practice | FastTypingLab',
  ...
  'court': {
    ...
    seoTitle: 'Court & Stenographer Typing Test — Free Practice | FastTypingLab',
  ...
  'ahc-ro-aro': {
    ...
    seoTitle: 'AHC RO/ARO Typing Test Online — Allahabad HC Practice | FastTypingLab',
  ...
  'delhi-police': {
    ...
    seoTitle: 'Delhi Police Typing Test — Head Constable Practice | FastTypingLab',
