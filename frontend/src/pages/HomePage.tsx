...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center justify-start pt-12 lg:pt-20 pb-16 min-h-[calc(100vh-64px)] relative bg-brand-bg text-brand-text font-sans selection:bg-brand-primary/30">
      ...
      <div className="container mx-auto px-6 relative z-10 w-full max-w-6xl py-6 flex flex-col items-center">
        ...
        <div className="text-center mb-12 lg:mb-16 max-w-4xl mx-auto relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight mb-6 leading-[1.15] text-brand-text">
          ...
          <p className="text-lg sm:text-xl text-brand-muted font-light max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="grid sm:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto w-full relative z-10">
          ...
          {/* Card 1: Learn Typing */}
          <div className="group relative bg-brand-surface/70 backdrop-blur-xl border border-brand-muted/10 rounded-3xl p-8 hover:border-brand-primary/30 hover:bg-brand-surface transition-all duration-300 shadow-sm hover:shadow-xl hover:shadow-brand-primary/5 flex flex-col min-h-[320px]">
            <div className="w-14 h-14 bg-brand-primary/10 rounded-2xl flex items-center justify-center mb-6 text-brand-primary border border-brand-primary/20 group-hover:scale-110 transition-transform duration-300">
              <Keyboard className="w-7 h-7" />
            </div>
            
            <h2 className="text-3xl font-bold mb-3 text-brand-text">Learn Typing</h2>
            <p className="text-brand-muted text-lg font-light leading-relaxed mb-10 flex-grow">
          ...
          <div className="group relative bg-brand-surface/70 backdrop-blur-xl border border-brand-muted/10 rounded-3xl p-8 hover:border-brand-secondary/30 hover:bg-brand-surface transition-all duration-300 shadow-sm hover:shadow-xl hover:shadow-brand-secondary/5 flex flex-col min-h-[320px]">
            <div className="w-14 h-14 bg-brand-secondary/10 rounded-2xl flex items-center justify-center mb-6 text-brand-secondary border border-brand-secondary/20 group-hover:scale-110 transition-transform duration-300">
              <Zap className="w-7 h-7" />
            </div>
            
            <h2 className="text-3xl font-bold mb-3 text-brand-text">Test Your Speed</h2>
            <p className="text-brand-muted text-lg font-light leading-relaxed mb-10 flex-grow">
        ...
        <div className="mt-14 lg:mt-20 flex flex-wrap items-center justify-center gap-8 sm:gap-12 text-sm sm:text-base text-brand-muted font-medium relative z-10">
        ...
        <div className="mt-12 w-full max-w-4xl mx-auto flex justify-center gap-6 text-sm text-brand-muted relative z-10">
