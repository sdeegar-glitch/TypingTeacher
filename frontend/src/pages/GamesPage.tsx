...
const GAMES = [
  ...
  },
  {
    ...
    title: 'Space Shooter',
    emoji: '🚀',
    desc: 'Blast the alien fleet by typing enemy words to fire your laser. Waves, combos and crits in deep space.',
  ...
  },
  {
    ...
    emoji: '🏰',
    desc: 'Defend your castle! Type words on approaching enemies to fire arrows and hold the walls.',
  ...
  },
  {
    ...
    title: 'Cyber Hacker',
    emoji: '💻',
    desc: 'Breach the firewall by typing code fast. Matrix-style hacking action with combos and crits.',
